...
4. **Exception/Error** — Error apa yang mungkin dilempar?
5. **Contoh penggunaan** — Minimal 2 contoh (basic & advanced)
6. **Catatan penting** — Side effect, limitation, deprecated?

**Format:** Gunakan docstring standar bahasa yang digunakan (Python: Google style, JS: JSDoc, Java: Javadoc)
